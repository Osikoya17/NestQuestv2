    ...
    <main className="flex ">
        ...
        <div className={`flex gap-[20px] space-y-1 m-30 flex-col my-[10px] w-[650px] sm:max-w-screen-sm px-[0px]` }>
            ...
            <div className="flex items-center justify-between p-[20px] h-[180px] bg-[#E8EEFF]">
                ...
                <div>
                    <img src="Asset 2 3.png" alt="icon" />
                </div>
            </div>
        ...
        <div className='hidden w-[325px] h-[570px] border-2 mx-[10px] my-[10px] sm:flex overflow-x-hidden'>
            <div id='1' className=''>
                <ContactCArd Name='Omotola Bolaji Adeyemi' img='tt.png' Details='I am 200level Student of Obafemi Awolowo University, I am studying Computer Science and Engineering' Numbers='0908855774532'email='@gmail.com' />
            </div>
        </div>
    </main>
