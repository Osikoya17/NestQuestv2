  ...
  return (
    ...
    <main className="flex items-center justify-center p-10 lg:pt-10 flex-col">
      ...
      <section className=" w-full mt-10  lg:mt-5 flex flex-col shadow-md p-4 lg:w-[35%] border border-slate-100">
        ...
        <Button
          type="primary"
          className=" h-10 mt-4 bg-[#0042EC] border-none text-sm ml-2 text-white"
        >
          Sign in
        </Button>
        <h5 className="text-center text-sm text-[#353535] mt-5">Or</h5>
        <Button className="mt-4 h-10 border border-slate-200 text-sm ml-2 text-black">
          Sign in with Google
        </Button>
      </section>

      <h6 className="mt-5 text-sm">
        Don't have an account? <span className="text-[#0042EC]">Sign Up</span>
      </h6>
    </main>
  );
}
