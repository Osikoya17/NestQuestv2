  ...
  return (
    <main className={inter.className}>
      ...
      <section className="sm:px-4 flex mt-8 justify-center">
        <div
          id="searchbar"
          className=" shadow-lg border-3 h-24 p-6  bg-[#E8EEFF] flex gap-x-8 items-center"
        >
          ...
          <Button className="bg-[#E8EEFF] flex justify-center w-40  border-[#376FFF] rounded-lg h-10 items-center text-[#376FFF] ">
            Write Us
          </Button>
        </div>
      </section>
